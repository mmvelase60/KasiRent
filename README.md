...
## Android testing progress

Physical Android testing has confirmed sample navigation, registration, initial test-record creation, Not charged display and recovery from a fixed tenant-detail rendering error. Charging/payment confirmation and the remaining device workflows are pending. See the [field validation record](docs/10-Testing/KR-TST-002-Android-Field-Validation.md).
